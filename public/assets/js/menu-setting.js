    ...
    $('body').append('' +
        '<div id="styleSelector" class="menu-styler">' +
            '<div class="style-toggler">' +
                '<a href="#!"></a>' +
            '</div>' +
            '<div class="prebuild-toggler">' +
                '<div class="prebuild-group">' +
                    '<a href="#!" class="prebuild-link-styler active">STYLER</a>' +
                    '<a href="#!" class="prebuild-link-layout">PREBUILD LAYOUTS</a>' +
                '</div>' +
            '</div>' +
            '<div class="style-block">' +
                ...
                '<button type="button" class="btn btn-success btn-square btn-block prebuild-link w-100">Try our Prebuild Layouts</button>' +
                ...
                '</div>' +
            '</div>' +
            '<div class="style-block-prebuild">' +
                '<h6 class="mb-2">Dasho Prebuild Layouts</h6>' +
                '<hr class="my-0">' +
                '<p class="f-12 my-2"><span class="text-c-red">*</span> in Prebuild Layout you redirect to new page</p>' +
                '<div class="theme-color prelayout-color">' +
                    '<div class="row justify-content-center">' +
                        '<div class="col-12">' +
                            '<a href="index-1.html" target="_blank">' +
                                '<div class="layout-block">' +
                                    '<img src="assets/images/layout/layout-1.jpg" alt="" class="img-fluid">' +
                        ...
                        '<div class="col-12">' +
                            '<a href="index-2.html" target="_blank">' +
                                '<div class="layout-block">' +
                                    '<img src="assets/images/layout/layout-2.jpg" alt="" class="img-fluid">' +
                                    '<span class="card-img-overlay">' +
                                        '<h5>Layout 2</h5>' +
                                    '</span>' +
                                '</div>' +
                        ...
                        '<div class="col-12">' +
                            '<a href="index-3.html" target="_blank">' +
                                '<div class="layout-block">' +
                                    '<img src="assets/images/layout/layout-3.jpg" alt="" class="img-fluid">' +
                                    '<span class="card-img-overlay">' +
                                        '<h5>Layout 3</h5>' +
                                    '</span>' +
                                '</div>' +
                        ...
                        '<div class="col-12">' +
                            '<a href="index-4.html" target="_blank">' +
                                '<div class="layout-block">' +
                                    '<img src="assets/images/layout/layout-4.jpg" alt="" class="img-fluid">' +
                                    '<span class="card-img-overlay">' +
                                        '<h5>Layout 4</h5>' +
                                    '</span>' +
                                '</div>' +
                        ...
                        '<div class="col-12">' +
                            '<a href="index-5.html" target="_blank">' +
                                '<div class="layout-block">' +
                                    '<img src="assets/images/layout/layout-5.jpg" alt="" class="img-fluid">' +
                                    '<span class="card-img-overlay">' +
                                        '<h5>Layout 5</h5>' +
                                    '</span>' +
                                '</div>' +
                        ...
                        '<div class="col-12">' +
                            '<a href="index-6.html" target="_blank">' +
                                '<div class="layout-block">' +
                                    '<img src="assets/images/layout/layout-6.jpg" alt="" class="img-fluid">' +
                                    '<span class="card-img-overlay">' +
                                        '<h5>Layout 6</h5>' +
                                    '</span>' +
                                '</div>' +
                        ...
                        '<div class="col-12">' +
                            '<a href="index-7.html" target="_blank">' +
                                '<div class="layout-block">' +
                                    '<img src="assets/images/layout/layout-7.jpg" alt="" class="img-fluid">' +
                                    '<span class="card-img-overlay">' +
                                        '<h5>Layout 7</h5>' +
                                    '</span>' +
                                '</div>' +
                        ...
                        '<div class="col-12">' +
                            '<a href="index-8.html" target="_blank">' +
                                '<div class="layout-block">' +
                                    '<img src="assets/images/layout/layout-8.jpg" alt="" class="img-fluid">' +
                                    '<span class="card-img-overlay">' +
                                        '<h5>Layout 8</h5>' +
                                    '</span>' +
                                '</div>' +
                        ...
                        '<div class="col-12">' +
                            '<a href="index-9.html" target="_blank">' +
                                '<div class="layout-block">' +
                                    '<img src="assets/images/layout/layout-9.jpg" alt="" class="img-fluid">' +
                                    '<span class="card-img-overlay">' +
                                        '<h5>Layout 9</h5>' +
                                    '</span>' +
                                '</div>' +
                        ...
                        '<div class="col-12">' +
                            '<a href="index-10.html" target="_blank">' +
                                '<div class="layout-block">' +
                                    '<img src="assets/images/layout/layout-10.jpg" alt="" class="img-fluid">' +
                                    '<span class="card-img-overlay">' +
                                        '<h5>Layout 10</h5>' +
                                    '</span>' +
                                '</div>' +
                        ...
                        '<div class="col-12">' +
                            '<a href="index-11.html" target="_blank">' +
                                '<div class="layout-block">' +
                                    '<img src="assets/images/layout/layout-11.jpg" alt="" class="img-fluid"/>' +
                                    '<span class="card-img-overlay">' +
                                        '<h5>Layout 11</h5>' +
                                    '</span>' +
                                '</div>' +
                        ...
                        '<div class="col-12">' +
                            '<a href="index-12.html" target="_blank">' +
                                '<div class="layout-block">' +
                                    '<img src="assets/images/layout/layout-12.jpg" alt="" class="img-fluid"/>' +
                                    '<span class="card-img-overlay">' +
                                        '<h5>Layout 12</h5>' +
                                    '</span>' +
                                '</div>' +
                        ...
                        '<div class="col-12">' +
                            '<a href="index-13.html" target="_blank">' +
                                '<div class="layout-block">' +
                                '<img src="assets/images/layout/layout-13.jpg" alt="" class="img-fluid"/>' +
                                    '<span class="card-img-overlay">' +
                                        '<h5>Layout 13</h5>' +
                                    '</span>' +
                                '</div>' +
                        ...
                        '<div class="col-12">' +
                            '<a href="index-14.html" target="_blank">' +
                                '<div class="layout-block">' +
                                '<img src="assets/images/layout/layout-14.jpg" alt="" class="img-fluid"/>' +
                                    '<span class="card-img-overlay">' +
                                        '<h5>Layout 14</h5>' +
                                    '</span>' +
                                '</div>' +
