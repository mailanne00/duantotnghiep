                                    ...
                                    <nav id="main-nav" class="main-nav">
                                        <ul id="menu-primary-menu" class="menu">
                                            ...
                                            <li class="menu-item menu-item-has-children">
                                                <a href="#">Danh mục</a>
                                                <ul class="sub-menu">
                                                    <li class="menu-item"><a href="{{ route('client.danhmuc') }}">Liên
                                                            quân</a>
                                                    </li>
                                                    <li class="menu-item"><a href="{{ route('client.danhmuc') }}">Liên
                                                            minh huyền
                                                    ...
                                                    <li class="menu-item"><a href="{{ route('client.danhmuc') }}">Free
                                                            fire</a>
                                                    </li>
                                                    <li class="menu-item"><a
                                                            href="{{ route('client.danhmuc') }}">PUBG</a>
                                                    </li>
                                                    <li class="menu-item"><a href="{{ route('client.danhmuc') }}">GTA
                                                            5</a></li>
                                        ...
                                        <div class="admin_active" id="header_admin">
                                            <div class="header_avatar">
                                                ...
                                                <div class="popup-user">
                                                    <img class="avatar" src="assets/images/avatar/avt-5.jpg"
                                                        alt="avatar" />
                                                    <div class="avatar_popup mt-20">
                                                        ...
                                                        <div class="links mt-20">
                                                            ...
                                                            <a class="mt-10" href="{{ route('client.login') }}"
                                                                id="logout">
                                                                <svg width="20" height="20"
                                                                    viewBox="0 0 20 20" fill="none"
                                                                    xmlns="../../../www.w3.org/2000/svg.html">
                    ...
                    <div class="chat-list">
                        <ul class="list-unstyled">
                            <li class="chat-user d-flex align-items-center mb-3">
                                ...
                                <span class="ms-2">Nguyễn Hoàng</span>
                            </li>
                            <li class="chat-user d-flex align-items-center mb-3">
                                <img src="assets/images/avatar/avt-2.jpg" alt="User Avatar" class="rounded-circle"
                                    width="40px" height="40px">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body space-y-20 pd-40">
                        ...
                        <p class="text-center">Người chơi tên là: <span class="price color-popup">HoangNguyen</span>
                        </p>
