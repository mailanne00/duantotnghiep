                            ...
                            <div class="item flex">
                                <div class="infor-item flex column1" style="width: 200px !important;">
                                    ...
                                    <div class="content-collection pad-t-4">
                                        @if ($user->nguoiDuocThue->biet_danh != null)
                                            <h6 class="title mb-15" style="transform: translateY(25px);"><a
                                                    href="{{route('client.taikhoan.show', $user->nguoiDuocThue->id)}}">{{ $user->nguoiDuocThue->biet_danh }}</a></h6>

                                        @else
                                            <h6 class="title mb-15" style="transform: translateY(25px);"><a
                                                    href="{{route('client.taikhoan.show', $user->nguoiDuocThue->id)}}">{{ $user->nguoiDuocThue->ten }}</a>
                                            </h6>
                                        @endif
                                ...
                                <div class="column td6" style="width:200px; text-align: unset">
                                    ...
                                    @if (empty($user->danhGia->toArray()) && $user->trang_thai == 1)
                                        <button type="button" class="btn btn-info" style="font-size: 15px;" data-toggle="modal"
                                            data-target="#rating_{{ $user->id }}">
                                            Đánh giá
                                        </button>
                                    @endif
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body pd-40">
                                                    ...
                                                    <form method="post" action="{{ route('client.danhGia', $user->id) }}"
                                                        onsubmit="return confirm('Bạn chắc chắn?)">
                                                        @csrf
                                                        <input type="hidden" name="user_id"
                                                            value="{{ $user->nguoiDuocThue->id }}">
                                                        <div class="mb-3">
