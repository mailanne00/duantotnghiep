                ...
                <div class="tab-content">
                    ...
                    <div id="pills-home1" role="tabpanel" aria-labelledby="pills-home-tab1"
                        ...
                        <div class="d-flex img-avatar"><img
                                src="https://files.playerduo.com/production/static-files/no_profile_small.jpg"
                        ...
                        <form class="payinfo-form row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="fieldGroup ">
                                    ...
                                    <p class="control-label">Tên hiển thị:</p><input type="text" name="name"
                                ...
                                <div class="fieldGroup ">
                                    ...
                                    <p class="control-label">Từ khóa (tai nghe, loa, ...)</p><input type="text"
                                        name="tagsString" placeholder="" maxlength="5000" autocomplete="false"
                                        value="">
                                </div>

                                <p class="control-label">Chi tiết</p>
