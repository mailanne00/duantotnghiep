                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12 personalinfo">
                        ...
                        <div class="d-flex img-avatar"><img
                                src="https://files.playerduo.com/production/images/avatar5.png" class="" alt="avatar"
                                sizes="sm">
                        ...
                        <form class=" from-userinfo">
                            ...
                            <div class="fieldGroup">
                                ...
                                <p class="control-label">Họ và tên</p><input type="text" name="name" placeholder=""
                                    maxlength="5000" autocomplete="false" value="hoact">
                            </div>
                            ...
                            <p class="control-label">Ngôn ngữ</p><select name="language">
                                <option disabled="">--- Chọn ngôn ngữ ---</option>
                                <option value="5b99f97c978dff3d115260c7">Tiếng Việt</option>
                            </select>

                            <p class="control-label">Quốc gia</p><select name="country">
