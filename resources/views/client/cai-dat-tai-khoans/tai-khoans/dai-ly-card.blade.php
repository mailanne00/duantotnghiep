                        ...
                        <form class="agency-form row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="fieldGroup agency-input ">
                                    ...
                                    <p class="control-label">Tên đại lý:</p><input type="text" name="name"
                                ...
                                <div class="fieldGroup agency-input "><input type="text" name="email" placeholder=""
                                        disabled="" maxlength="5000" autocomplete="false"
                                        value="chuthihoa98bgg@gmail.com">
                                </div>
                                        ...
                                        <div style="height: 100%; position: relative; overflow: hidden;">
                                            ...
                                            <div
                                                ...
                                                <div style="line-height: 20px; margin: 15px 0px;"><span
                                                        style="color: rgba(0, 0, 0, 0.87); font-size: 14px;">Trang này
                                                        không
