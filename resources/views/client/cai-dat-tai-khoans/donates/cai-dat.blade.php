                ...
                <div class=" tabs">
                    ...
                    <ul role="tablist" id="pills-tab3" class="nav nav-tabs">
                        ...
                        <li role="presentation" class=""><a class="active" id="pills-home-tab3" data-bs-toggle="pill"
                                data-bs-target="#pills-home3" role="tab" aria-controls="pills-home3"
                                aria-selected="true" href="#"><i class="far fa-images"></i>ẢNH</a></li>

                        <li role="presentation" class=""><a id="pills-home-tab4" data-bs-toggle="pill"
                                data-bs-target="#pills-home4" role="tab" aria-controls="pills-home4"
                                aria-selected="true" href="#"><i class="fa fa-music"></i>ÂM THANH</a></li>

                        <li role="presentation" class="active"><a id="pills-home-tab5" data-bs-toggle="pill"
                                data-bs-target="#pills-home5" role="tab" aria-controls="pills-home5"
                                aria-selected="true" href="#"><i class="fa fa-cogs"></i>CÀI ĐẶT KHÁC</a></li>
                        ...
                        <div id="pills-home5" role="tabpanel" aria-labelledby="pills-home-tab5"
                            ...
                            <form class="donatesetting-form">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="row"><label class="col-md-6">Lọc từ khóa tránh spam donate</label>
                                        <textarea name="predictSpamWords" class="col-md-6 col-sm-12 col-xs-12 key-lock-donate"
                                            placeholder="Thêm nhiều từ khoá bằng cách xuống dòng" rows="5"></textarea>
                                    </div>
                                        ...
                                        <div class="col-md-6 playerduo-text">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="col-xs-4 ">
                                                    ...
                                                    <div class="fieldGroup "><input type="text" name="text"
                                    ...
                                    <div class="row"><label class="col-md-6">Màu văn bản</label><input
                                            name="textColor" class="col-md-6 col-sm-12 col-xs-12" type="color"
                                            value="red"></div>

                                    <div class="row"><label class="col-md-6">Hiệu ứng chữ</label><select
                                            name="textEffect" class="col-md-6 col-sm-12 col-xs-12 donate-setting-select">
