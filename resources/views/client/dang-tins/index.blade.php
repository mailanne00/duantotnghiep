            ...
            <div class="card-player">
                ...
                <div class="row">
                    ...
                    @foreach ($dangtins as $dangtin)
                            ...
                            <div class="player-information-card">
                                ...
                                <div class="player-information">
                                    ...
                                    <h3 class="player-name">
                                        ...
                                        <img src="{{ Storage::url($dangtin->taiKhoan->anh_dai_dien) }}" alt=""
                        ...
                        <div class="modal fade" id="exampleModal" style="height:900px" tabindex="-1"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content row"
                                    style="transform: translateX(-210px); width: 1020px; flex-direction: row">
                                    <div class="modal-left col-6">
                                        <button type="button" class="btn-prev btn btn-default">
                                            <i class="far fa-angle-left"></i>
                                        </button>
                                        <video playsinline="" autoplay="" mediatype="video" loop="" controls=""
                                            controlslist="nodownload" height="330px">
                                            <source src="{{ Storage::url($dangtin->video) }}" type="video/mp4">
                                        </video>
                                    ...
                                    <div class="modal-right col-6">
                                        <div class="card-top">
                                            <div class="media-player media">
                                                <div class="media-middle media-left"><a href="/daum58" target="_blank"
                                                        rel="noopener noreferrer">
                                                        <div class="avt-rank avt-sm">
                                                            <img src="https://files.playerduo.net/production/images/c3f4846f-3d42-47cd-acd5-0ff67fe7465e__76dd5440-7c27-11ef-9376-b533eb6f1b4c__page_avatar.jpg"
                                                                class="avt-1-15 avt-img" alt="PD"
                                                                style="width:50px; border-radius:50%">
                                                        </div>
                                                    </a></div>
                                                <div class="media-middle media-body"><a
                                                        href="/stories?user=612b2dc2983659446297c59a">
                                                        <p class="name-player-review color-vip-1">Ebe thích ăn gà🍗</p>
                                                        <p>3 ngày trước</p>
                                                    </a></div>
                                                <div class="media-middle media-right"><a href="/dauum58" target="_blank"
                                                        rel="noopener noreferrer"><button type="button"
                                                            class="btn btn-danger">Thuê</button></a></div>
                                            </div>
                                            ...
                                            <div class="description">
                                                <p class="note"><a target="_blank" href="https://playerduo.net/dauum58"
                                                        class="link">{{ $dangtin->noi_dung }}</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
