                        ...
                        <div class="form-infor-profile">
                            ...
                            <fieldset>
                                ...
                                <div class="mt-2">
                                    ...
                                    <img src="{{ \Illuminate\Support\Facades\Storage::url($user->cccd) }}" alt="Ảnh CCCD" class="img-fluid" style="max-width: 200px;">
                                </div>
                                @endif
                            </fieldset>
                            ...
                            <fieldset>
                                ...
                                <input type="file" name="personal_video" accept="video/*" class="form-control text-white bg-dark">
                                ...
                                <div class="mt-2">
                                    ...
                                    <video controls class="img-fluid" style="max-width: 300px;">
                                        <source src="{{ \Illuminate\Support\Facades\Storage::url($user->personal_video) }}" type="video/mp4">
