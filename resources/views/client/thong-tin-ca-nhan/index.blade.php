            ...
            <form action="{{ route('client.thong-tin-ca-nhan.update') }}" method="POST" class="form-profile"
                ...
                <div class="row">
                    ...
                    <div class="tf-create-item tf-section">
                        ...
                        @endif
                        <div class="themesflat-container">
                            <form action="{{ route('client.thong-tin-ca-nhan.update') }}" method="POST"
                                class="form-profile" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-xl-3 col-lg-4 col-md-6 col-12">
                                            ...
                                            <div class="form-infor-profile">
                                                <div class="info-account">
                                                    ...
                                                    <fieldset class="mb-3">
                                                        <h4 class="title-infor-account text-white mb-2">Giới tính</h4>
                                                        <select
                                                            class="form-select text-white bg-dark border-0 rounded-2 p-2"
                                                            name="gioi_tinh" required>
                                                            <option value="" class="text-white bg-dark" disabled
                                                                selected>Chọn giới
                                                                tính</option>
                                                            <option value="male"
                                                                {{ $user->gioi_tinh == 'male' ? 'selected' : '' }}
                                                                class="text-white bg-dark">Nam</option>
                                                            <option value="female"
                                                                {{ $user->gioi_tinh == 'female' ? 'selected' : '' }}
                                                                class="text-white bg-dark">Nữ</option>
                                                            <option value="other"
                                                                {{ $user->gioi_tinh == 'other' ? 'selected' : '' }}
                                                                class="text-white bg-dark">Khác</option>
                                                        </select>
                                                    </fieldset>
                                                    <fieldset>
                                            ...
                                            <div class="form-infor-profile" id="cccd-video">
                                                ...
                                                <div class="form-infor-profiles">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p>
                                                            @if ($user->trang_thai_xac_thuc == 1)
                                                                <span class="text-success" style="font-size: 18px;">Đã xác
                                                                    thực</span>
                                                            @elseif ($user->trang_thai_xac_thuc == 2)
                                                                <span class="text-danger" style="font-size: 18px;">Từ chối
                                                                    xác thực</span>
                                                            @else
                                                                <span class="text-danger" style="font-size: 18px;">Chưa
                                                                    xác thực</span>
                                                            @endif
                                                        </p>
                                                    </div>
