        ...
        <div class="themesflat-container">
            <div class="row">
                    ...
                    <div class="wrap-box explore-1 flex mg-bt-40">
                        <div class="seclect-box style-1">
                            ...
                            <div id="all-items" class="dropdown">
                                ...
                                <ul>
                                    <li><a href="{{ request()->fullUrlWithoutQuery(['gia']) }}"><span>Giá</span></a>
                                    </li>
                        ...
                        <div class="sc-card-product menu_card style-h7">
                            <div class="card-media">
                                <a href="{{ route('client.taikhoan.show', $taiKhoan->id) }}"><img
                                        ...
                                        alt="Image"
                                        style="max-height: 220px; min-height: 220px; object-fit:cover"></a>
                            </div>
                            <div class="card-title">
                                <h5>
                                    <a href="{{ route('client.taikhoan.show', $taiKhoan->id) }}">
                                        {{ $taiKhoan->biet_danh ?? $taiKhoan->ten }}
                                    </a>
                                </h5>
                            </div>
                            <div class="meta-info">
                                ...
                                <div class="tags">{{ $taiKhoan->countDanhGia }} <i
                                        class="fas fa-star f-10 m-l-10 text-c-yellow"></i>({{ $taiKhoan->countRent }})
                                </div>
                            </div>
                        </div>
                        @endforeach
                ...
                <div class="col-md-12 wrap-inner load-more text-center">
                    <a href="#" id="loadmore" class="sc-button loadmore fl-button pri-3"><span>XEM
                            THÊM</span></a>
                </div>
            </div>
        </div>
