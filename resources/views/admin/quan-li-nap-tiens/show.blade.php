                ...
                <div class="row">
                    <div class="col-6">
                        <form>
                            ...
                            @endif
                            <button type="submit" onclick="return confirm('Bạn có chắc chắn muốn duyệt đơn này ?')" class="btn btn-primary mb-4" name="btnDuyet">Duyệt</button>
                            <button type="submit" onclick="return confirm('Bạn có chắc chắn muốn huỷ đơn này ?')" class="btn btn-danger mb-4" name="btnHuy">Huỷ</button>
                        </form>
                    </div>
                    <div class="col-md-6">
                       @if($quanLiNapTien->phuong_thuc->ten_phuong_thuc == 'Nạp qua tài khoản MB bank')
